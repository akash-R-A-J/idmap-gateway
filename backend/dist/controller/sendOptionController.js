...
export const sendInputMap = new Map();
// will create a webauthn challenge and send it back to the client
export const sendOptionController = async (req, res) => {
    ...
    try {
        ...
        console.log("sending challenege to the user for verification during send txn", sendOptions);
...
//# sourceMappingURL=sendOptionController.js.map