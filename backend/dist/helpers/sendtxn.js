...
export const sendTxnToServer = async (userId, message, session) => {
            ...
            await sub.subscribe("sign-result", async (msg) => {
                try {
                    ...
                    if (data.result_type === "sign-result") {
                        ...
                        console.log(`✅ Signature ${currentCount}/${TOTAL_NODES} from node ${data.server_id}:`, data.data);
